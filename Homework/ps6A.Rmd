...
> ANSWER: I will be working on wrangling the indexes' data with Sam by reading and wrangling the csv file obtained from the sites. Leah will work on scraping the timeline data. We will meet on Wednesday to discuss what we have on Zoom, and will get the finalized wrangled data in by Thursday. 
...
> Answer: We got a figure similar to that of Figure 14.2 in the textbook.

```{r}
# insert the path to where you want to save the data
# a good choice would be your problem sets folder within your git repo
my_path <- "/Users/thainguyen/Desktop/STUDYYYYYYYYYYYYYYYYYYYYYY/College/Fall 2020/Data Science STAT 231/Git/Stat-231-repo/Homework/Cholera data"
