...
> ANSWER: The histogram shows us that tenure length varies from 0 to more than 30 years, with median tenure of 6 to 7 years and 15 to 16 years, and no justices serve 11-12 years, 25-26 years or 28-29 years.
...
plot <- ggplot(justices2) +
  geom_histogram(aes(x=tenure_length), binwidth = 1) +
  xlab("Length of tenure in years") +
  ggtitle("Distribution of tenure length")
...
```{r, linewidth = 60}
quotes_camus <- read_csv("/Users/thainguyen/Desktop/STUDYYYYYYYYYYYYYYYYYYYYYY/College/Fall 2020/Data Science STAT 231/Git/Stat-231-repo/Homework/ps5B/quotes.csv")

quote_for_the_day_2 <- quotes_camus[sample(1:nrow(quotes_camus), size = 3),]

quote_for_the_day_2$together
```
